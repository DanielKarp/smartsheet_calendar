...
YEARS_AND_QUARTERS = {
    ...
    24: {  # projected from FY23 dates
        1: (date(2023, 7, 30), date(2023, 10, 29)),
        2: (date(2023, 10, 30), date(2024, 1, 28)),
        3: (date(2024, 1, 29), date(2024, 4, 29)),
        4: (date(2024, 4, 30), date(2024, 7, 29))
        },
    }
