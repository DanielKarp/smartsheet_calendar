...
YEARS_AND_QUARTERS = {
    ...
    23: {  # projected, copied from fy22 dates
        1: (date(2022, 8, 1), date(2022, 10, 24)),
        2: (date(2022, 10, 25), date(2023, 1, 23)),
        3: (date(2023, 1, 24), date(2023, 5, 1)),
        4: (date(2023, 5, 2), date(2023, 7, 31))
        },
    }
